...
def _make_api_request(url: str, headers: dict, method: str = "GET", body: Optional[dict] = None, max_retries: int = 3, retry_delay: float = 1.0):
    ...
    for attempt in range(max_retries):
        try:
            ...
            if attempt < max_retries - 1:
                sleep(retry_delay)
                continue
            raise Exception("Failed to connect to the API server")
